...
data "aws_iam_policy_document" "github_actions_assume_role" {
  statement {
    ...
    condition {
      ...
      #   repo:nhitruong96@71067517/pet-care@1342417979:ref:refs/heads/main
      # instead of the classic
      #   repo:nhitruong96/pet-care:ref:refs/heads/main
      ...
      # only the numeric IDs, anchored after "nhitruong96@" and "/pet-care@".
      test     = "StringLike"
...
resource "aws_iam_role" "github_actions_pet-care" {
  name               = "github_actions_pet-care"
  assume_role_policy = data.aws_iam_policy_document.github_actions_assume_role.json
}

# ecr/ec2/route53 statements mirror the core repo's terraform/iam/policies/
# terraform_pet-care_policy.tf (granted to the old static-key IAM user) --
...
resource "aws_iam_role_policy" "github_actions_pet-care_policy" {
  name = "github_actions_pet-care_policy"
  role = aws_iam_role.github_actions_pet-care.id
  ...
  policy = <<EOF
{
    ...
    "Statement": [
        ...
        },
        {
            ...
            "Resource": "arn:aws:ecr:${var.region}:975050308029:repository/pet-care"
        },
        {
            "Effect": "Allow",
            "Action": [
        ...
        },
        {
            ...
            "Resource": "arn:aws:s3:::prod-levantine-terraform-bucket/pet-care/*"
        },
        {
            "Effect": "Allow",
            "Action": [
